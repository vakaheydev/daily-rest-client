...
public abstract class AbstractRestClient<T> implements Client<T> {
    ...
    /**
     * Get name of entity unique name. For example for {@link com.vaka.dailyClient.model.User User} it is "login", for
     * {@link com.vaka.dailyClient.model.Task Task} - "name"
     *
